...
class VerifyEmailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        automaticallyImplyLeading: false, // it will disable and hide the back arrow on app bar
        actions: [
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(TText.testEmail,style: Theme.of(context).textTheme.labelLarge,textAlign: TextAlign.center,),
              const SizedBox(height:TSizes.spaceBtwItems),
